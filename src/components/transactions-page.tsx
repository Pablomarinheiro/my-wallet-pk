  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="rounded-3xl sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {tx ? "Editar" : "Nova"} {kind === "income" ? "receita" : "despesa"}
          </DialogTitle>
        </DialogHeader>
        ...
        <CardContent className="p-4 md:p-6">
          <div className="mb-4 grid grid-cols-1 gap-2 md:grid-cols-[1fr_auto_auto]">
            ...
            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
              <SelectTrigger className="h-10 min-w-[160px] rounded-2xl">
          ...
          {isLoading ? (
            ...
            <div className="py-12 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Adicione sua primeira {kind === "income" ? "receita" : "despesa"} para começar.
              </p>
            </div>
          ) : (
                  ...
                  {filtered.map((t) => {
                    ...
                    return (
                      <TableRow key={t.id}>
                        ...
                        <TableCell
                          className={`text-right font-bold ${kind === "income" ? "text-success" : "text-foreground"}`}
                        >
          ...
          <div className="mt-4 flex flex-col items-center justify-between gap-3 sm:flex-row">
            <div className="text-xs text-muted-foreground">
              Mostrando {filtered.length} de {list.length} resultados
            </div>
          </div>
        </CardContent>
      </Card>
