      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
        <div>
          ...
          <p className="mt-1 pl-10 text-xs text-muted-foreground">
            Entenda seus padrões de gastos com IA
          </p>
        </div>
        {!insights.isIdle && (
          <Button
            ...
            aria-label="Gerar novos insights"
          >
            {insights.isPending ? (
        ...
        {insights.isIdle && (
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="text-sm text-muted-foreground">
              Gere um resumo com IA sobre seus hábitos de gasto, categorias e orçamento deste mês.
            </p>
            <Button size="sm" className="rounded-xl shadow-soft" onClick={() => insights.mutate()}>
