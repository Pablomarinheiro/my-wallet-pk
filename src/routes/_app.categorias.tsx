              ...
              {ICON_OPTIONS.map((key) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => setIcon(key)}
                    className={`grid h-9 w-9 place-items-center rounded-xl border-2 ${icon === key ? "border-primary bg-primary/10" : "border-transparent bg-secondary"}`}
                    aria-label={key}
                  >
                    <I className="h-4 w-4" />
                  </button>
