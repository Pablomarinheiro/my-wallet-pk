      ...
      <Card className="rounded-3xl border-border/70 bg-gradient-to-br from-primary via-primary to-[oklch(0.42_0.22_262)] text-primary-foreground shadow-elevated">
        <CardContent className="p-6">
          ...
          <div className="mt-3 flex flex-wrap gap-4 text-sm">
            <div>
              <span className="text-white/70">Contas: </span>
              <span className="font-semibold">{accounts.length}</span>
            </div>
            <div>
              <span className="text-white/70">Investido: </span>
        ...
        <Card className="rounded-3xl border-dashed">
          <CardContent className="p-10 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Adicione sua primeira conta para começar a acompanhar seu saldo.
            </p>
            <div className="mt-4">
              <AccountDialog
                trigger={
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {accounts.map((a) => {
            ...
            return (
              <Card
                key={a.id}
                className="rounded-3xl border-border/70 shadow-soft transition-shadow hover:shadow-elevated"
              >
                  ...
                  <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3">
                    ...
                    <div className="flex gap-1">
                      ...
                      <Button
                        ...
                        aria-label="Excluir"
                        onClick={() => {
                          if (confirm(`Excluir conta "${a.name}"?`))
                            del.mutate(a.id, {
