...
import { Sun, Moon, Monitor, Globe, Bell, DatabaseBackup, type LucideIcon } from "lucide-react";
...
export const Route = createFileRoute("/_app/configuracoes")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Personalize aparência, idioma e notificações do My Wallet.",
      },
    ],
  }),
...
function ConfigPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Configurações"
        description="Personalize a aparência, idioma e notificações da sua conta."
      />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Section icon={DatabaseBackup} title="Dados">
          ...
          <Row label="Importar CSV" hint="Traga o histórico de outro app ou do banco">
            <Button asChild variant="outline" className="rounded-2xl">
              <Link to="/relatorios">Importar</Link>
            </Button>
          </Row>
        </Section>
      </div>
